...
class ProfileFieldController extends Controller
{
	...
	{
		if(Yii::app()->user->checkAccess('User.ProfileField.View')){
	...
	{
		if(Yii::app()->user->checkAccess('User.ProfileField.Create')){
	...
	{
		if(Yii::app()->user->checkAccess('User.ProfileField.Update')){
			$model=$this->loadModel();
			if(isset($_POST['ProfileField']))
			{
				$model->attributes=$_POST['ProfileField'];
	...
	{
		if(Yii::app()->user->checkAccess('User.ProfileField.Delete')){
	...
	{
		if(Yii::app()->user->checkAccess('User.ProfileField.Admin')){
